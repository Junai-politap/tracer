                    ...
                    @foreach ($list_mata_kuliah as $mata_kuliah)
                        <tr>
                            <td class="text-center">
                                <div class="btn-group">
                                    <a href="{{ url("show-mata-kuliah/$mata_kuliah->id") }}"
                                        class="btn btn-info"><span class="fa fa-info"></span> Lihat</a>

                                    <a href="{{ url("edit-mata-kuliah/$mata_kuliah->id") }}"
                                        class="btn btn-warning"><span class="fa fa-edit"></span> Edit</a>

                                    <a onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini?')" href="{{ url("delete-mata-kuliah/$mata_kuliah->id") }}"
