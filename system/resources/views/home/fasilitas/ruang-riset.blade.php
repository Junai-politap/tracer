...
@section('title', 'Riset Prodi - ')
@section('content')
    @include('layout.home.page-title', [
        'page_title' => 'Ruang Research And Development',
    ])
    ...
    <section class="choosing-area"> 
        <div class="container">
            <div class="sec-title text-center">
                <div class="title"> Data Ruangan Research And Development</div>
                <div class="dector thm-bg-clr center"></div>
            </div>
            <div class="row">
                @foreach ($list_fasilitas->where('jenis_fasilitas', 'Research and Development') as $fasilitas)
                    <a href="{{ url("show-riset/$fasilitas->id") }}">
                        <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                            <div class="single-choosing-item">
                                ...
                                <div class="text-holder">
                                    ...
                                    <a class="readmore" href="{{ url("show-riset/$fasilitas->id") }}">Detail</a>
                                </div>
                            </div>
                        </div>
                    </a>
